...
const AuthenticationWrap = Styled.div`
  ...
  .pllace-authentication-wrap{
    @media only screen and (max-width: 767px){
      padding: 0 15px;
    }
  }
  .pllace-authentication-brand{
    text-align: center;
  }
`;
...
const AuthFormWrap = Styled.div`
  ...
  .pllace-authentication-top{
    padding: 20px;
    text-align: center;
    border-bottom: 1px solid #E3E6EF;
    .pllace-authentication-top__title{
      font-size: 20px;
      font-weight: 600;
      line-height: 1;
      margin-bottom: 0;
